...
{
  cout << "Postac trojmianu kwadratowego: " <<TKw.a<<"x^2 +"<<TKw.b<<"x +"<<TKw.c<<endl;
}
...
int main() {
  ...
  if (TKw.a == 0) {
    cout<<"Wprowadzone wsplczynniki a musi byc rozny od zera.\n";
    return 1;
  }
  ...
  switch (WyliczPierwiastki(TKw,&X1,&X2)) {
    ...
    case 1:
      cout << "Istnieje jedno rozwiaznie: " << X1 << endl;
      break;

    case 0:
      cout << "Nie istnieje rozwiazanie w zbiorze liczb rzeczywistych\n";
      break;
  }
